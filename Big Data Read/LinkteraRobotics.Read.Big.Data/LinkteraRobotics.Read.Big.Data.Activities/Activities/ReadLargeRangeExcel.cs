...
{
    [LocalizedDisplayName(nameof(Resources.ReadLargeRangeExcel_DisplayName))]
    [LocalizedDescription(nameof(Resources.ReadLargeRangeExcel_Description))]
    public class ReadLargeRangeExcel : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.ReadLargeRangeExcel_Range_DisplayName))]
        [LocalizedDescription(nameof(Resources.ReadLargeRangeExcel_Range_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Range { get; set; }

        [LocalizedDisplayName(nameof(Resources.ReadLargeRangeExcel_Excelfilepath_DisplayName))]
        [LocalizedDescription(nameof(Resources.ReadLargeRangeExcel_Excelfilepath_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Excelfilepath { get; set; }

        [LocalizedDisplayName(nameof(Resources.ReadLargeRangeExcel_Sheetname_DisplayName))]
        [LocalizedDescription(nameof(Resources.ReadLargeRangeExcel_Sheetname_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> Sheetname { get; set; }

        [LocalizedDisplayName(nameof(Resources.ReadLargeRangeExcel_OutputTable_DisplayName))]
        [LocalizedDescription(nameof(Resources.ReadLargeRangeExcel_OutputTable_Description))]
