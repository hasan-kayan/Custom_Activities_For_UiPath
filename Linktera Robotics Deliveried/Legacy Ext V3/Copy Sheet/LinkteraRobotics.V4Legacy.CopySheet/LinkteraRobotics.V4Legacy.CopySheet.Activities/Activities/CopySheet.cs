...
using LinkteraRobotics.V4Legacy.CopySheet.Activities.Properties;
...
namespace LinkteraRobotics.V4Legacy.CopySheet.Activities
{
    ...
    public class CopySheet : ContinuableAsyncCodeActivity
    {
        ...
        [LocalizedDisplayName(nameof(Resources.CopySheet_FilePath_DisplayName))]
        [LocalizedDescription(nameof(Resources.CopySheet_FilePath_Description))]
