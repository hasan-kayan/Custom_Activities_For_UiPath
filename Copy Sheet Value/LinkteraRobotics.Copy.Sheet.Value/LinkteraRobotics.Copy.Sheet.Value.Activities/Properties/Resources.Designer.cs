...
namespace LinkteraRobotics.Copy.Sheet.Value.Activities.Properties {
    ...
    public class Resources {
        ...
        /// </summary>
        public static string CopySheetValue_Description {
            get {
                return ResourceManager.GetString("CopySheetValue_Description", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Copy Sheet Value.
        /// </summary>
        public static string CopySheetValue_DisplayName {
            get {
                return ResourceManager.GetString("CopySheetValue_DisplayName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Excel File path which user will wokr on..
        /// </summary>
        public static string CopySheetValue_Filepath_Description {
            get {
                return ResourceManager.GetString("CopySheetValue_Filepath_Description", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string CopySheetValue_Filepath_DisplayName {
            get {
                return ResourceManager.GetString("CopySheetValue_Filepath_DisplayName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The sheet name to copy..
        /// </summary>
        public static string CopySheetValue_Sheetname_Description {
            get {
                return ResourceManager.GetString("CopySheetValue_Sheetname_Description", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string CopySheetValue_Sheetname_DisplayName {
            get {
                return ResourceManager.GetString("CopySheetValue_Sheetname_DisplayName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The sheet name to create new sheet and paste the data..
        /// </summary>
        public static string CopySheetValue_SheetnamePaste_Description {
            get {
                return ResourceManager.GetString("CopySheetValue_SheetnamePaste_Description", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to sheetnamePaste.
        /// </summary>
        public static string CopySheetValue_SheetnamePaste_DisplayName {
            get {
                return ResourceManager.GetString("CopySheetValue_SheetnamePaste_DisplayName", resourceCulture);
            }
        }
